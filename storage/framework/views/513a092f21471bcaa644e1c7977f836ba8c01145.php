                    ...
                    <form class="form-edit-add" role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="permissions checkbox">
                                ...
                                ?>
                                <?php $__currentLoopData = TCG\Voyager\Models\Permission::all()->groupBy('table_name')->sortBy('table_name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table => $permission): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <li>
